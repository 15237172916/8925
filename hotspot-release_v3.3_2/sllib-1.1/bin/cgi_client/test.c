...
#define FILE_NAME "rtsp-mdev-vpu0-vpp_pv"
#define FILE_PATH_NAME "/tmp/rtsp-mdev-vpu0-vpp_pv"
...
#endif
#if 1
	if(chmod(FILE_PATH_NAME, S_IRUSR|S_IXUSR|S_IWUSR|S_IXOTH|S_IROTH|S_IWOTH|S_IRGRP|S_IWGRP|S_IXGRP)!=0)
	{
		 printf("\ncm fail");
		 return 0;
	}
