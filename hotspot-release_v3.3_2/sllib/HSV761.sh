...
cp ./Web/HSV761/web ../../img-make-hotspot/user-server/ -r #server:add user/web
cp ./tmp/HSV761/run_s.sh ../../img-make-hotspot/user-server/run.sh #server: user/run.sh

echo "RX user"
rm ../../img-make-hotspot/user-client/web -rf #client: rm web
cp ./Web/HSV761/web_client ../../img-make-hotspot/user-client/web -r #client:add user/web
cp ./tmp/HSV761/run_c.sh ../../img-make-hotspot/user-client/run.sh #client: user/run.sh

echo "cp TX web to /tmp/update/"
rm ./tmp/HSV761/update/web -rf #server: rm tmp/update/web
cp ./Web/HSV761/web ./tmp/HSV761/update/ -rf #server: add tmp/update/web
cd ./tmp/HSV761/update&&./ln.sh
cd ../../../

rm ../../img-make-hotspot/execute-server/update/* -r
cp ./tmp/HSV761/update/web ../../img-make-hotspot/execute-server/update/ -rf
...
cd ./bin/CGI/HSV761/cgi-bin-control && ./build.sh && cd ../../../../
...
sudo cp ./bin/Web/HSV761/web /tftpboot -r
...
sudo cp ./bin/Web/HSV761/web /mnt/nfs/tftpboot -r
