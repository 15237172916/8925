...
function get_line()
{
	...
	var a;
	var j = 0;
	var urlstr = "http://"+hostip+"/cgi-bin/get_RX_line.cgi";
	var obj=window.parent.document.getElementById("myIframe_left").contentWindow;
	var obj1=window.parent.document.getElementById("myIframe_selectTxButton").contentWindow;
	var obj2=window.parent.document.getElementById("myIframe_changeRxName").contentWindow;
	var obj3=window.parent.document.getElementById("myIframe_changeTxName").contentWindow;
			//console.log('window.parent.IF_online');
	if(window.parent.IF_online==0)
	{
		//console.log(obj);
		$.ajax({ 
			//type:"GET",
			...
			success:function(data)
			{
				for(i=0;i<128;i++)
				{
					a= $(data).find("RX"+(i+1)).text();
					if(a==0)
					{
							obj.document.getElementById("b"+num[i]).style.display="none"; 
					 		obj2.document.getElementById("divBlock"+num[i]).style.display="none"; 
					}
				
				}
				for(i=0;i<24;i++)
				{
					a= $(data).find("TX"+(i+1+200)).text();
					if(a==0)
					{
						
						obj1.document.getElementById("TX"+num1[i]).style.display="none";  
						obj3.document.getElementById("divBlock"+num1[i]).style.display="none";  
					}
				
				}
				
					window.parent.IF_online=1;
					document.getElementById("ONLINE").style.backgroundColor="#990000";
			}
		});	
	...
	else
	{
		for(i=0;i<128;i++)
				...
				obj.document.getElementById("b"+num[i]).style.display="block";
				obj2.document.getElementById("divBlock"+num[i]).style.display="block"; 
				}
				for(i=0;i<24;i++)
				{
				//console.log(obj1);	
				obj1.document.getElementById("TX"+num1[i]).style.display="block";
										obj3.document.getElementById("divBlock"+num1[i]).style.display="block";  
				}
				window.parent.IF_online=0;
				document.getElementById("ONLINE").style.backgroundColor="#4d4d4d";
	}
}
