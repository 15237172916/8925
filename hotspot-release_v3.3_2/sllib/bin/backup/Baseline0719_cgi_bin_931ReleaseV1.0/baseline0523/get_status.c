...
void main(void)
{
    ...
    if(0==share_mem->sm_run_status.ucInputStatus)
    {
     printf("content-Type:text/xml\n\n");
       printf("<set><input_type> ---</input_type><input_video> ---</input_video><input_audio> ---</input_audio><RTSPC>未启动</RTSPC><RTPC>未启动</RTPC><RTMPC>未启动</RTMPC><RTSPE>OFF</RTSPE><RTPE>OFF</RTPE><RTMPE>OFF</RTMPE></set>\n");
       return;
