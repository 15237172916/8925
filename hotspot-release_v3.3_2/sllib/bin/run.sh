#! /bin/sh
sleep 2;
ifconfig eth0 192.168.1.128 up netmask 255.255.255.0
...
mount -o nolock 192.168.1.253:/home/ubuntu/Work/8925/code/test_git/hotspot-release_v3.3_2/sllib/bin /mnt
