...
cp ./Web/HSV7011/web ../../img-make-hotspot/user-server/ -r #server:add user/web
cp ./tmp/HSV7011/run_s.sh ../../img-make-hotspot/user-server/run.sh #server: user/run.sh

echo "RX user"
rm ../../img-make-hotspot/user-client/web -rf #client: rm web
cp ./Web/HSV7011/web_client ../../img-make-hotspot/user-client/web -r #client:add user/web
cp ./tmp/HSV7011/run_c.sh ../../img-make-hotspot/user-client/run.sh #client: user/run.sh

echo "cp TX web to /tmp/update/"
rm ./tmp/HSV7011/update/web -rf #server: rm tmp/update/web
cp ./Web/HSV7011/web ./tmp/HSV7011/update/ -rf #server: add tmp/update/web
cd ./tmp/HSV7011/update&&./ln.sh
cd ../../../

rm ../../img-make-hotspot/execute-server/update/* -r
cp ./tmp/HSV7011/update/web ../../img-make-hotspot/execute-server/update/ -rf
...
cd ./bin/CGI/HSV7011/cgi-bin-control && ./build.sh && cd ../../../../
...
sudo cp ./bin/Web/HSV7011/web /tftpboot -r
...
sudo cp ./bin/Web/HSV7011/web /mnt/nfs/tftpboot -r
