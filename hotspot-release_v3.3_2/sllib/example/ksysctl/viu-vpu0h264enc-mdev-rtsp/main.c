...
static int tx_witch_multicast_main(void)
{
	printf("tx_witch_multicast_main  start \n");
...
/******** jason add 20180830 *****************/
	...
	ret = pthread_create(&witch_multicast_handler, NULL, tx_witch_multicast_main, NULL);
	if (ret) {
