...
public:
  static BasicUsageEnvironment* createNew(TaskScheduler& taskScheduler, NET_INTERFACE interface);
...
protected:
  BasicUsageEnvironment(TaskScheduler& taskScheduler, NET_INTERFACE interface);
